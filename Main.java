...
public User opening(Scanner sc, List<User> users) {
...
public void setUser(Scanner sc, User user) {
...
public Food input() {
        ...
        System.out.print("熱量: ");
        food.setCalories(sc.next()); 
        
        System.out.print("蛋白質: ");
        food.setProtein(sc.next()); 
        
        System.out.print("脂肪: ");
        food.setFat(sc.next()); 
        
        System.out.print("碳水化合物: ");
        food.setCarbs(sc.next()); 
        
        System.out.print("鈉: ");
        food.setSodium(sc.next());
        
        System.out.print("鉀: ");
        food.setPotassium(sc.next()); 
        
        System.out.print("鈣: ");
        food.setCalcium(sc.next()); 
        
        System.out.print("鎂: ");
        food.setMagnesium(sc.next()); 
        
        System.out.print("鐵: ");
        food.setIron(sc.next()); 
        
        System.out.print("鋅: ");
        food.setZinc(sc.next()); 
        
        System.out.print("磷: ");
        food.setPhosphorus(sc.next()); 
        
        System.out.print("膽固醇: ");
        food.setCholesterol(sc.next());
        
        return food;
}

public void advise(User user) {
    ...
    if (user.record.getTotalFat() > 0.3 * food.getCalories()) {
        System.out.println("今日攝取「脂肪」已過量");
        System.out.println("您每日脂肪建議攝取量為：" + (0.2 * user.getDailyCalorieNeeds() / 9) + "克");
    }

    if (user.record.getTotalCarbs() > 0.75 * food.getCalories()) {
